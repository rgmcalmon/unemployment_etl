...
/*
https://www.kaggle.com/mikejohnsonjr/united-states-crime-rates-by-county/discussion/27312
index: Table Index
...
*/
DROP TABLE IF EXISTS unemployment_and_crime_by_year_month;

CREATE TABLE unemployment_and_crime_by_year_month (
	id int NOT NULL AUTO_INCREMENT,
	county varchar(100),
	state_code varchar(2),
	state_name varchar(50),
	crime_year year(4),
	crime_month tinyint(2),
